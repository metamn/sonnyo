...
module.exports = {
  ...
  // .js files to concat
  js_src: [
    "site/components/framework/**/*.js",
    "site/components/project/**/*.js",
    "site/components/pages/**/*.js"
  ],
  ...
  styleguide_js_src: [
    "styleguide/components/pages/**/*.js",
    "styleguide/components/framework/**/*.js",
    "styleguide/components/project/**/*.js"
  ],
  ...
  // .js files to move
  font_move_src: "site/assets/fonts/*.*",

  // .js files to move destination
  font_move_dest: "dist/assets/fonts",
  ...
  styleguide_menu_framework_dest:
    "styleguide/components/project/styleguide-menu/__framework/styleguide-menu__framework.html.swig",

  // Styleguide menu destination file for BEM project
  styleguide_menu_project_dest:
    "styleguide/components/project/styleguide-menu/__project/styleguide-menu__project.html.swig",

  // Which folders to copy from /site to /styleguide
  styleguide_folders_copy: [
    "site/components/framework/**/**/*",
    "site/components/project/**/**/*"
  ],

  // Which folders to remove from /styleguide
  styleguide_folders_remove: [
    "styleguide/components/pages/framework/**/**/*",
    "styleguide/components/pages/project/**/**/*"
  ],
